...
class Employyee {
    ...
    public Employyee(String name, int id) {
        this.name = name;
        this.id = id;
    }
...
public class DescendingSortedListOfEmplyeesWithLambda {
    public static void main(String[] args) {
        ...
        // Sorting employees by name in descending order using Collections.sort with lambda expression
